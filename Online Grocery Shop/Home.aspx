...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <div style="float: left; width: 300px;">
            <div class="sideLogin">
                <div class="welcome">Welcome To Saqer store</div>
                <p>
                    At Saqer store our goal is to provide you with the wide varieties of Fruits and Vegetables.
                </p>
                <table>
                    <tr>
                        <td>UserName
                ...
                <div class="contact_informatin">
                    ...
                    <table class="call">
                        ...
                        <tr>
                            ...
                            <td>saqersimplilearnproject@gmail.com</td>
                        </tr>
                    </table>
